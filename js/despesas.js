...
(function () {
  ...
  function _injetarHTML() {
    var html = [
      ...
      '<button id="despFab" onclick="abrirDespesas()" title="Despesas" style="position:fixed;bottom:88px;right:24px;z-index:299;background:#a12c7b;color:#fff;border:none;border-radius:999px;padding:10px 18px;font-size:12px;font-weight:700;cursor:pointer;box-shadow:0 4px 20px rgba(161,44,123,.4);display:flex;align-items:center;gap:6px;font-family:inherit;transition:transform .15s">',
